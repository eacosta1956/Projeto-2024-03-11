...
*/
  ...
  const [mensagemErro, setMensagemErro] = useState(''); // substitui o alert
  ...
  */
  function CalcularArea() {
    if (base > 0 && altura > 0) {
      ...
      setMensagemErro(''); // acrescentado para substituir o alert
    } else {
       setMensagemErro('Insira todos os dados!'); // acrescentado para substituir o alert
      }
  }
